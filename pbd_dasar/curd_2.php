...
<table border=1 cellpadding=2>
    <tr>
        <td colspan="4"> <a href="curd_2.php?a=input">INPUT</td>
    </tr>
    <tr>
        <td>ID</td>
        <td>KODE</td>
...
<form action="curd_2.php?a=list" method=""post>
    ...
    {echo "checked=\"checked"\""; } else {echo ""; }  ?>> -
     <input type="radio" name="akreditasi" value="A" <?php if ($row["akreditasi"]=='-' || $row ["akreditasi"]=='') 
    {echo "checked=\"checked"\""; } else {echo ""; }  ?> > A
    <input type="radio" name="akreditasi" value="B" <?php if ($row["akreditasi"]=='-' || $row ["akreditasi"]=='') 
    {echo "checked=\"checked"\""; } else {echo ""; }  ?> > B
    <input type="radio" name="akreditasi" value="C" <?php if ($row["akreditasi"]=='-' || $row ["akreditasi"]=='') 
